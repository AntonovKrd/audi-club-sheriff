...
public enum BotMessageEnum {
    ...
    REGISTRATION_SUCCESS_MESSAGE("""
            ...
            если все хорошо, ты сможешь попасть в чат!"""),
    //activation messages
    ...
    ACCEPT_USER_INFO_MESSAGE("""
            Регистрация завершена успешно.\s\s
            Прежде чем перейти в чат, ознакомьтесь с важной для участника клуба информацией.\s\s
            1. В клубе существует дисконтная система «Audi Club Краснодар», на сегодняшний день это серьезная система привилегий,
            позволяющая вам неплохо экономить, будучи членом клуба. Для участия, вам нужно приобрести карту у @eldar_vahidovich \s
            В группе разрешено рекламировать свои предприятия и просто мастерские разных направлений, только партнерам клуба,
            которые есть в списке. Почти все партнеры, участники клуба. \s
            Поэтому, если у вас есть организация, любого направления, которая может быть интересна владельцам премиум бренда
            и вы можете придумать особые привелегии для участников клуба, пишите @eldar_vahidovich, это бесплатно. \s
            Список партнеров клуба, для держателей клубных карт и условия - http://www.vagmeyer.ru/discount_audi_club_krasnodar/ \s
            2. У клуба есть свой инстаграм где выкладываются клубные машины -  @audiclubkrasnodar. (https://instagram.com/audiclubkrasnodar?igshid=YmMyMTA2M2Y=)\s
            Хэштеги нашего клуба - #audiclubkrasnodar #audibanda \s
            3. По многочисленным просьбам, чтобы не мусорить в чатах, создана группа «барахолка» для поиска и продажи 
            своих запчастей и всего что подходит к Ауди. https://t.me/+vp7ICf761NNiOGUy \s
            4. Чтобы не пропускать события и мероприятия в клубе, 
            вам нужно в обязательном порядке находится в группе новостей https://t.me/audiclubkrasnodar \s
            5. В основном чате, мы общаемся на разные темы, т.к большинство близко знакомы и дружат давно... но, бывает такое,
            что вам нужна какая то помощь с автомобилем или просто совет, а ваш вопрос, убежал по ленте и остался без внимания...
            для этого создана группа «ауди ремонт», где пишем строго только по автомобильной теме, 
            просим уважать друг-друга, не спамить попусту...  https://t.me/+YPQIc6ZR6iNiYWUy \s"""),
    ACCEPT_USER_MESSAGE("""
            💥💥💥💥💥💥💥💥
            Чтобы попасть в основной чат нажми на кнопку ниже ⬇"""),
    DECLINE_ADMIN_MESSAGE("Заявка пользователя отклонена"),
    ACCEPT_ADMIN_MESSAGE("Заявка пользователя одобрена"),
    //welcome to group message
    WELCOME_GROUP_MESSAGE("""
            , добро пожаловать!\s
            Это сообщество владельцев Audi.\s
            Здесь дружба и общение. Придерживайтесь общепринятых норм поведения.\s
            В чате могут находится только владельцы Ауди 😉
                        
            За скрин переписок и передачу личных данных, а также любую рекламу - удаление из чата!
                        
            Добро пожаловать в Ауди Клуб!)
                        
            Список партнеров клуба тут 👇🏼
                        
            http://www.vagmeyer.ru/discount_audi_club_krasnodar/
                        
            Если вам пишут в лс с подозрительными предложениями, сообщите админу об этом!"""),
    //errors
